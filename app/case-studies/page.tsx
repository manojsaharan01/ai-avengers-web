...
export default async function CaseStudiesPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
      <div className="mb-12">
        <h1 className="font-serif text-5xl font-semibold text-[#043927] mb-4">Case Studies</h1>
        ...
        <div className="space-y-6">
          {caseStudies.map((cs: any) => (
            <Link
              ...
              className="group block bg-white border border-[#E5E5E2] rounded-xl overflow-hidden hover:border-[#043927]/30 hover:shadow-sm transition-all"
            >
              <div className="flex flex-col sm:flex-row">
                {/* Image */}
                {cs.featuredImage?.asset ? (
                  <div className="relative sm:w-64 h-48 sm:h-auto flex-shrink-0 bg-[#e8f4ef]">
                    <Image
                  ...
                  <div className="sm:w-64 h-48 sm:h-auto flex-shrink-0 bg-[#e8f4ef] flex items-center justify-center">
                    <span className="font-serif text-5xl text-[#043927]/20">AA</span>
                  </div>
                )}
                  ...
                  {cs.heroMetrics?.length > 0 && (
                    <div className="flex flex-wrap gap-6 mt-5 pt-5 border-t border-[#E5E5E2]">
                      {cs.heroMetrics.map((m: any, i: number) => (
                        <div key={i}>
                          <div className="font-serif text-2xl font-semibold text-[#043927]">{m.metric}</div>
      ...
      <div className="mt-16 p-8 bg-[#043927] rounded-2xl text-center">
        ...
        <p className="text-[#e8f4ef]/80 mb-6">
